                  ...
                  {user ? (
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <a
                          ...
                          onClick={closeMenu}
                          className="inline-flex items-center gap-2 rounded-lg px-4 py-2.5 text-xs font-semibold text-white bg-[#25D366] hover:bg-[#20BA5A] transition-colors"
                        >
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white text-xs font-bold py-3 rounded-lg transition-all active:scale-[0.99]"
                      >
                      ...
                      <a
                        ...
                        rel="noopener noreferrer"
                        onClick={closeMenu}
                        className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg py-3 text-xs font-semibold text-white bg-[#25D366] hover:bg-[#20BA5A] transition-colors"
                      >
                        <FaWhatsapp className="h-4 w-4" />
                        WhatsApp
                      </a>
