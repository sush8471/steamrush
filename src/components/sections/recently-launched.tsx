        ...
        <div className="flex items-center justify-between gap-4 mb-4 lg:mb-6">
          ...
          {games.length > 6 && (
            <div className="hidden lg:flex items-center gap-2">
              <button
                onClick={() => scroll('left')}
                className="p-2 rounded-lg bg-[#121622] hover:bg-[#202838] border border-[#202838] hover:border-[#00D2FF]/30 text-white transition-all duration-200 hover:shadow-[0_0_15px_rgba(0,210,255,0.2)] cursor-pointer"
