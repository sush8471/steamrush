...
export const GlareCard = ({
  ...
  return (
      <div
        ...
        className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[180px] sm:w-[220px] md:w-[260px] [aspect-ratio:9/16]"
        ref={refElement}
      onPointerMove={(event) => {
